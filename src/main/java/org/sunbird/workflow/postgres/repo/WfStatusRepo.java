...
public interface WfStatusRepo extends JpaRepository<WfStatusEntity, String> {
    ...
    @Modifying
    @Query("UPDATE WfStatusEntity WF SET WF.approvalState = :approval_state WHERE WF.userId =:userId")
    void findByUserId(@Param("userId") String userId, @Param("approval_state") String approvalState);
}
